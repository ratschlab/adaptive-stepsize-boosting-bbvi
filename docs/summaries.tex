...
\def\biblio{\newpage\bibliographystyle{apalike}\bibliography{refs}}
% Example definitions.
% --------------------
...
\newcommand{\INPROGRESS}{\todo[color=yellow,inline]{in progress}}
...
\newcommand{\comm}[1]{\textcolor{OliveGreen}{#1}}
