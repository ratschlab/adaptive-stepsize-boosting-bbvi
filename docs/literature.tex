...
\begin{align}
  ...
  \begin{enumerate}
    ...
    \mypar{Boosting Variational inference} \cite{guo2016boosting} \INPROGRESS \\
    Iterative boosting by $q_{i + 1} = (1 - \gamma) q_i + \gamma h_i$.
    \comment{Very similar to Frank-Wolfe}. Optimization is to find optimal $\gamma$
    ...
    direction by step size $\gamma$. \comment{Approximate solutions to the linear
    ...
    Using quadratic upper bound \ref{eqn:quad_upper} \comment{ L-continous gradient
