""" Variational Inference model used to just get the ELBO (loss) value.
Inspired from VariationalInference.py
"""
...
from boosting_bbvi.core.infmodel import IModel
...
class VIModel(IModel):
  ...
  def __init__(self, *args, **kwargs):
    super(VIModel, self).__init__(*args, **kwargs)
  ...
  def initialize(self, optimizer=None, var_list=None, use_prettytensor=False,
    ...
    """
    super(VIModel, self).initialize(*args, **kwargs)
  ...
  def build_loss_and_gradients(self, var_list):
    ...
    Any derived class of `VIModel` **must** implement
    this method.
