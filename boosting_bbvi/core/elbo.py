""" Get the ELBO (loss) value.
Inspired from KLqp.py, similar to relbo.py
"""
...
from boosting_bbvi.core.vi import VIModel
...
class ReparameterizationKLqp(VIModel):
  """Variational inference with the KL divergence
...
class ReparameterizationKLKLqp(VIModel):
  """Variational inference with the KL divergence
...
class ReparameterizationEntropyKLqp(VIModel):
  """Variational inference with the KL divergence
...
class ScoreEntropyKLqp(VIModel):
  """Variational inference with the KL divergence
